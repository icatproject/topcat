(function() {
    ...
    angular
        .module('angularApp')
        .service('ConfigUtils', ConfigUtils);
    ...
    function ConfigUtils($q){
        ...
        this.getAllFacilityNames = function(facilities) {
         ...
         */
        this.getFacilitiesFromConfig = function(facilities){
            var data = [];
         ...
         */
        this.getLoggedInFacilitiesFromConfig = function(facilities, sessions){
            var data = [];
        ...
        this.getLoggedInFacilities = function(facilities, sessions){
            var data = [];
            var loggedIn = _.keys(sessions);
         ...
         */
        this.getDefaultSortArray = function(column) {
        ...
        this.getSessionValueForFacility = function(sessions, facility) {
