...
package uk.ac.stfc.topcat.icatclient.v45;
...
import org.icatproject_4_5_0.DatafileFormat;
import org.icatproject_4_5_0.DatafileParameter;
import org.icatproject_4_5_0.Dataset;
import org.icatproject_4_5_0.DatasetParameter;
import org.icatproject_4_5_0.DatasetType;
import org.icatproject_4_5_0.Facility;
import org.icatproject_4_5_0.FacilityCycle;
import org.icatproject_4_5_0.ICAT;
import org.icatproject_4_5_0.ICATService;
import org.icatproject_4_5_0.IcatException;
import org.icatproject_4_5_0.IcatExceptionType;
import org.icatproject_4_5_0.IcatException_Exception;
import org.icatproject_4_5_0.Investigation;
import org.icatproject_4_5_0.InvestigationInstrument;
import org.icatproject_4_5_0.InvestigationParameter;
import org.icatproject_4_5_0.InvestigationUser;
import org.icatproject_4_5_0.Keyword;
import org.icatproject_4_5_0.Login.Credentials;
import org.icatproject_4_5_0.Login.Credentials.Entry;
import org.icatproject_4_5_0.ParameterValueType;
import org.icatproject_4_5_0.Publication;
import org.icatproject_4_5_0.Shift;

/**
 *
 */
public class ICATInterfacev45 extends ICATWebInterfaceBase {
    private ICAT service;
    private String serverName;
    private final static Logger logger = Logger.getLogger(ICATInterfacev45.class.getName());

    public ICATInterfacev45(String serverURL, String serverName) throws MalformedURLException {
    ...
    @Override
    public ArrayList<TInvestigation> getAllInvestigations(String sessionId) throws TopcatException {
        logger.info("getAllInvestigations: sessionId (" + sessionId + ")");
        ArrayList<TInvestigation> investigationList = new ArrayList<TInvestigation>();
        try {
            ...
            convertToTopcatException(ex, "getAllInvestigations");
        } catch (Throwable e) {
            logger.error("getAllInvestigations: " + e.getMessage());
            throw new InternalException(
                    "Internal error, getAllInvestigations threw an unexpected exception, see server logs for details");
